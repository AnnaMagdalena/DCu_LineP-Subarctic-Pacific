...
# load the dataset
data <-read_csv('C~/Cu_NPacific-Fig5-MS.csv')
...
p1 <- data %>%
	...
	scale_color_manual(name="Region 1",
										 labels = c("5, Tanita et al., 2015","6, Moffett & Dupont, 2007",
								     "CR27, Takano et al., 2014","TR15, Takano et al., 2014"),
										 values=c("#000000","#000000","#000000","#999999"))+
	scale_shape_manual(name="Region 1",
										 labels = c("5, Tanita et al., 2015","6, Moffett & Dupont, 2007",
										"CR27, Takano et al., 2014","TR15, Takano et al., 2014"),
										 values=c(1,2,17,17))+
...
p2 <- data %>%
	...
	scale_shape_manual(name="Region 2",
										 labels = c("19, Fujishima et al., 2001","4, Moffett & Dupont, 2007"),
										 values=c(16,2))+
...
plots <- plot_grid (p1,p2,p3,p4,p5,p7,p6, ncol = 5,align = "h")

#save plot in the format of choice
